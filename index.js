...
function obtenerPrefijoPlantilla(tipo) {
    if (tipo === "1") return "PP-";
    if (tipo === "2") return "PS-";
    if (tipo === "3") return "CA-";
...
function obtenerPrefijoDesdeCard() {
    ...
    let tipo = "1";
    if (pdf === "Protocolodepruebas.pdf") tipo = "1"; // Formulario 1 con vistas viewParte1, viewParte2, viewParte3 y viewParte4
    if (pdf === "ProtocolodepruebasconPS.pdf") tipo = "2"; //Formulario 1 con vistas de viewParte1, viewParte2 y viewParte3 (sin la vista de viewParte4)+ Formulario con vista de viewPuestaServicio
    if (pdf === "Cambiodeajustes.pdf") tipo = "3"; // Formulario de viewCambioAjuste
    
    // Asume que esta función devuelve el prefijo basado en 'tipo'
    return obtenerPrefijoPlantilla(tipo); 
}
    ...
    nextButton.addEventListener("click", () => {
        ...
        if (selectedPdf === "Protocolodepruebas.pdf") {
            ...
            document.querySelectorAll(".hide-in-ps").forEach(field => {
                ...
                if (input && field.id === "campo-nodofinal") {
...
document.querySelectorAll('.btn-next').forEach(btn => {
  ...
  btn.addEventListener('click', e => {
    ...
    const vistasConCruces = ["viewParte2", "viewParte3"];
...
// let camposExcluidos = [];
  ...
  // 1. Determinar qué campos conservar según la vista actual
  // Vistas de Protocolo de Prueba (viewParte1, viewParte2, viewParte3, etc.)
//  if (vista.id.startsWith("viewParte")) {
//    camposExcluidos = ["CodigoUnico", "fecha", "semana", "hora"];
//  } 
  // Vista de Cambio de Ajustes
//  else if (vista.id === "viewCambioAjuste") {
    // Nota: Añade el campo de hora si también lo usas aquí
    //   camposExcluidos = ["CodigoUnicoCA", "fechaCA", "SemanaCA"]; 
  //} 
  // Vista de Puesta en Servicio
  //else if (vista.id === "viewPuestaServicio") {
    //camposExcluidos = ["CodigoUnicoPS", "fechaPS", "SemanaPS", "horaPS"];
  //}

  // 2. Recorre todos los campos de la vista actual
  //vista.querySelectorAll("input, select, textarea").forEach(el => {
    ...
    // 3. Limpieza según el tipo de campo
...
async function enviarFormulario(btn, campos, urlFlujo) {
  ...
  try {
    ...
    // ✅ Restaurar solo la fecha correspondiente
      ...
      mostrarMensaje("❌ Error al enviar datos, tus datos están guardados en borrador", "error");
    }
  } catch (error) {
    console.error("Error en fetch:", error);
    mostrarMensaje("⚠️ Hubo un problema con la conexión,tus datos están guardados en borrador", "error");
  } finally {
    btn.disabled = false;
...
document.getElementById("enviarBtn").addEventListener("click", (e) => {
  ...
  enviarFormulario(
    e.target,
    [
      "CodigoUnico","plantillaTipo","sed","alim","nodofinal","enlace","circuito","fecha","semana","hora","tension","Celda",
...
// =============================
// 🟢 ENVÍO FORMULARIO 3 (viewPuestaServicio)
// =============================
