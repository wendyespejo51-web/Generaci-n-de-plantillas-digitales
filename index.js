...
// =============================
// Botón check (visor PDF) - Lógica de Reset de Toggle
// =============================
if (nextButton) {
    nextButton.addEventListener("click", () => {
        ...
        // 🆕 LÓGICA PARA RESTABLECER EL TOGGLE
...
if (nextButton) {
  nextButton.addEventListener("click", () => {
    ...
    // ===============================
      ...
      // DESACTIVAR SUGERENCIAS SED
        desactivarAutocompleteSED();

      // Mostrar hoja 1 por defecto
      document.getElementById("viewParte1").classList.add("active-view");
        // ----------------------------
        ...
        document.querySelectorAll(".hide-in-ps").forEach(field => {
          ...
          // Si tienen input dentro, removemos required
          const input = field.querySelector("input");
          if (input) {
...
const togglePS = document.getElementById("togglePS");
const togglePSLabel = document.getElementById("togglePSLabel"); // <span> al lado del toggle

if (togglePS && togglePSLabel) {
  // Inicializar texto según estado inicial
  togglePSLabel.textContent = togglePS.checked ? "Puesta en servicio" : "Protocolo de prueba";

  togglePS.addEventListener("change", () => {
    if (togglePS.checked) {
      // Mostrar Hoja de Puesta en servicio
      document.getElementById("viewParte1").classList.remove("active-view");
      document.getElementById("viewPuestaServicio").classList.add("active-view");

      // Cambiar texto del toggle
      togglePSLabel.textContent = "Puesta en servicio";
    } else {
      // Volver a Protocolo de prueba de la protección
      document.getElementById("viewPuestaServicio").classList.remove("active-view");
      document.getElementById("viewParte1").classList.add("active-view");

      // Cambiar texto del toggle
      togglePSLabel.textContent = "Protocolo de prueba";
    }
  });
}
...
// ====================================================================
// INICIALIZACIÓN DE AMBOS COMBOBOXES
// ====================================================================
...
function mostrarVista(targetId) {
  mostrarSiguiente(targetId);
}
...
function mostrarSiguiente(targetId) {
  ...
  // Ocultar pestañas/header cuando entras a formularios
...
document.querySelectorAll('.btn-next').forEach(btn => {
  ...
  btn.addEventListener('click', e => {
    ...
    if (!okReq) {
      e.preventDefault();
      // mostrarMensaje ya fue
      //  llamado internamente por validarCamposRequeridos
      return;
    }
    ...
    // ⚠️ Solo ejecutar validación cruzada si la vista actual contiene esos campos
// Ejecutar validación cruzada SOLO en las vistas donde se requieren
...
function limpiarFormulario(vista) {
  ...
  const camposExcluidos = vista.id.startsWith("viewParte")
    ...
    : ["CodigoUnicoCA", "fechaCA", "SemanaCA"]; ["CodigoUnicoPS", "fechaPS", "SemanaPS","horaPS"];
