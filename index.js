...
async function cargarHistorial(force = false)  {
  ...
  try {
    // Usamos process.env para acceder a la variable
    const response = await fetch(process.env.https://default1c0051dd45964b1a9849d060735057.69.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/96f54f3519fe4103a06ff43041ea6c67/triggers/manual/paths/invoke?api-version=1FLOW_HISTORIAL_REGISTROSsp=%2Ftriggers%2Fmanual%2FrunFLOW_HISTORIAL_REGISTROSsv=1.0FLOW_HISTORIAL_REGISTROSsig=2mY86UW0eVHyITHt35jFWbgo2Oet1CH6BJUy91Cbjcs, {
      method: 'POST',
