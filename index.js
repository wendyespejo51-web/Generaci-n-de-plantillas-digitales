...
async function obtenerDatosDesdeFlujo(payload) {
  ...
  const urlFlujo = "https://default1c0051dd45964b1a9849d060735057.69.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/2814051425604f6290304a11b63686cf/triggers/manual/paths/invoke?api-version=1"FLOW_RELLENAR_AJUSTES_RECOMENDADOS"sp=%2Ftriggers%2Fmanual%2Frun"FLOW_RELLENAR_AJUSTES_RECOMENDADOS"sv=1.0"FLOW_RELLENAR_AJUSTES_RECOMENDADOS"sig=7lR5vpJvXZsqk05SXTMvHYuxoBTkMbhjnII6FNdXEGU";
...
document.getElementById("enviarBtn").addEventListener("click", (e) => {
  ...
  enviarFormulario(
    ...
    "https://default1c0051dd45964b1a9849d060735057.69.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/e30b9abb12584fbaa6939129547bb248/triggers/manual/paths/invoke?api-version=1"FLOW_GENERAR_PLANTILLA_PP"sp=%2Ftriggers%2Fmanual%2Frun"FLOW_GENERAR_PLANTILLA_PP"sv=1.0"FLOW_GENERAR_PLANTILLA_PP"sig=2ONLDOmbTWMdxkm4zDsj2Sd0P7zcPx1078HJmoEHMlo"
  );
});
...
document.getElementById("enviarBtn2").addEventListener("click", (e) => {
  ...
  enviarFormulario(
    ...
    "https://default1c0051dd45964b1a9849d060735057.69.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/044b35f2957e4f09993d645b7c946ebf/triggers/manual/paths/invoke?api-version=1"FLOW_GENERAR_PLANTILLA_CA"sp=%2Ftriggers%2Fmanual%2Frun"FLOW_GENERAR_PLANTILLA_CA"sv=1.0"FLOW_GENERAR_PLANTILLA_CA"sig=m1y-2obOZX_EG4XwdLBCCyyiCqJqxFQT8HB6crZmYWs"
  );
});
...
document.getElementById("enviarBtn3").addEventListener("click", (e) => {
    ...
    enviarFormulario(
        ...
        "https://default1c0051dd45964b1a9849d060735057.69.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/34b57ed7099a42ff9a2fc50790a44655/triggers/manual/paths/invoke?api-version=1"FLOW_GENERAR_PLANTILLA_PS"sp=%2Ftriggers%2Fmanual%2Frun"FLOW_GENERAR_PLANTILLA_PS"sv=1.0"FLOW_GENERAR_PLANTILLA_PS"sig=0TtJ_sOw1kk8vQm-9uU1VNHBCyJPm8uuId6cAsaQjpQ"
    );
});